...
local function list_update(w, buttons, label, data, objects)
  ...
  for i, o in ipairs(objects) do
    ...
    if cache then
      ...
      tbm = wibox.container.margin(tb, dpi(12), dpi(12))
      ibm = wibox.container.margin(ib, dpi(10), dpi(0), dpi(8), dpi(6))
    ...
    -- If the process is focused the background will be this specific color - therefore opacity should also be 1
    local isFocused = bg ~= "#192933"
    if isFocused then
        ib.opacity = 1
    else
        ib.opacity = 0.5
